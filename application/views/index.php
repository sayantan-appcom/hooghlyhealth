...
<head>
  ...
  <title>:- Welcome to Hooghly Health by Nibedita:-</title>
        ...
        <div class="row">
          <div class="banner-info">
            <div class="banner-logo text-center">
              <h2 class="white">Disease Investigation Monitoring System</h2>
            </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <div class="credits">
              ...
              -->
              Designed and developed by National Informatics Centre, Hooghly District Center
            </div>
          </div>
        </div>
      </div>
