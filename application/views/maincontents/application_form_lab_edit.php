 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
   ...
   <section class="content">
      <div class="row">
        <!-- left column -->
        <form role="form" method="POST" action="<?php echo site_url('Health_Home/application_form_insert');?>">
      ...
      <div class="col-md-4">
          ...
          <div class="box box-info">
            <!-- form start -->
              ...
              <!--  <div class="form-group">
                  <label for="exampleInputPassword1">Week <span class="star">*</span></label>
                    <select class="form-control select2" style="width: 100%;" id="week_cd" name="week_cd" required="">
                      <option value="">Select which week you have enter</option>
                      <?php
                          //foreach($get_week as $row)
                            { 
                             // echo '<option value="'.$row->week_cd.'">'.$row->week_name.'</option>';
                            }
                      ?>
                    </select>
                </div>   -->
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Patient PIN <span class="star">*</span></label>
              ...
              <div class="box-body"> 
                <div class="form-group">
                  <label for="exampleInputEmail1">Patient Address <span class="star">*</span></label>
                    <textarea class="form-control" id="patient_address" name="patient_address" autocomplete="off" rows="2" placeholder="Enter Patient Address" required="" maxlength="100"></textarea>
                </div> 
               <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">Test Done <span class="star">*</span></label>
                    <select class="form-control select2" style="width: 100%;" id="test_done" name="test_done" required="">
                      <option value="">Select whether test is done or not</option>
                      <option value="01">Yes</option>
                      <option value="02">No</option>
                    </select>
                </div>  
                <div class="form-group">
                  <label for="exampleInputPassword1">Test Status </label>
                    <select class="form-control select2" style="width: 100%;" id="test_status" name="test_status" required="" disabled="">
                      <option value="00">Select Test Status</option>
