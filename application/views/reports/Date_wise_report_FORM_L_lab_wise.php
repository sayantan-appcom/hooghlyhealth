...
<table class="table" align="center" border="2">
  ...
  <tr class="bg-info">
	...
	<a class="star" target="_blank" href="<?php echo site_url('Reports/fetch_positive_test'); ?>/<?php echo $disease_sub_id;?>/<?php echo $institution_code;?>/<?php echo $start_date ;?>/<?php echo $end_date ;?>  "><?php echo $sample_tested1['POSITIVE'];?></a>	
